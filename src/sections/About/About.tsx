  ...
  return (
    <section id="about" className="py-16 md:py-24 flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 items-stretch">
        ...
        <div className="md:col-span-5 rounded-2xl bg-[#181c24]/90 border border-[#38bdf8]/30 backdrop-blur-2xl p-6 sm:p-7 shadow-xl shadow-cyan-950/20 flex flex-col justify-between relative overflow-hidden group hover:border-[#38bdf8]/50 transition-all">
          <div className="absolute -right-12 -top-12 w-40 h-40 bg-[#38bdf8]/10 rounded-full blur-3xl pointer-events-none" />
          <div className="flex flex-col gap-4 z-10">
            <div className="flex items-center justify-between">
              <div className="w-11 h-11 rounded-xl bg-[#262a33] border border-[#38bdf8]/30 flex items-center justify-center text-[#38bdf8] shadow-inner">
          ...
          <div className="flex flex-wrap gap-1.5 pt-5 border-t border-white/[0.06] z-10">
            {['React', 'React Router', 'Redux Toolkit', 'JavaScript ES6+', 'Tailwind CSS', 'Vite'].map((t, idx) => (
              <span key={idx} className="font-mono text-[11px] px-2.5 py-1 rounded-md bg-[#1c2028] text-[#38bdf8] border border-white/[0.05]">
                {t}
              </span>
            ))}
          </div>
        ...
        <div className="md:col-span-4 rounded-2xl bg-[#181c24]/90 border border-white/[0.08] backdrop-blur-2xl p-6 sm:p-7 shadow-xl flex flex-col justify-between relative overflow-hidden group hover:border-[#c0c1ff]/40 transition-all">
          <div className="absolute -right-12 -top-12 w-40 h-40 bg-[#c0c1ff]/10 rounded-full blur-3xl pointer-events-none" />
          <div className="flex flex-col gap-4 z-10">
            <div className="flex items-center justify-between">
              <div className="w-11 h-11 rounded-xl bg-[#262a33] border border-[#c0c1ff]/30 flex items-center justify-center text-[#c0c1ff] shadow-inner">
          ...
          <div className="flex flex-wrap gap-1.5 pt-5 border-t border-white/[0.06] z-10">
            {['Elementor Pro', 'Custom CSS', 'WooCommerce', 'WoodMart', 'LearnDash', 'PHP Hooks'].map((t, idx) => (
              <span key={idx} className="font-mono text-[11px] px-2.5 py-1 rounded-md bg-[#1c2028] text-[#c0c1ff] border border-white/[0.05]">
                {t}
              </span>
            ))}
          </div>
        ...
        <div className="md:col-span-3 rounded-2xl bg-[#181c24]/90 border border-white/[0.08] backdrop-blur-2xl p-6 sm:p-7 shadow-xl flex flex-col justify-between relative overflow-hidden group hover:border-[#56e5a9]/40 transition-all">
          <div className="absolute -right-12 -top-12 w-40 h-40 bg-[#56e5a9]/10 rounded-full blur-3xl pointer-events-none" />
          <div className="flex flex-col gap-4 z-10">
            <div className="flex items-center justify-between">
              <div className="w-11 h-11 rounded-xl bg-[#262a33] border border-[#56e5a9]/30 flex items-center justify-center text-[#56e5a9] shadow-inner">
            ...
            <h3 className="font-display text-lg sm:text-xl font-bold text-[#dfe2ee]">
              Backend Foundations
            </h3>
          ...
          <div className="flex flex-wrap gap-1.5 pt-5 border-t border-white/[0.06] z-10">
            {['Node.js', 'Express', 'MongoDB', 'JWT', 'REST APIs'].map((t, idx) => (
              <span key={idx} className="font-mono text-[11px] px-2 py-0.5 rounded-md bg-[#1c2028] text-[#56e5a9] border border-white/[0.05]">
                {t}
              </span>
            ))}
          </div>
