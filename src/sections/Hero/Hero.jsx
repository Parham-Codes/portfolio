...
export const Hero = () => {
  ...
  // Animation variants for staged entrance
      ...
      >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3">
          ...
          <motion.div
            ...
            className="p-3 sm:p-3.5 rounded-xl bg-[#121620]/60 border border-white/[0.06] hover:border-[#58c4dc]/35 hover:bg-[#121620]/90 transition-colors duration-200 flex items-center gap-3 group"
          >
          ...
          <motion.div
            variants={stackCardVariants}
            whileHover={shouldReduceMotion ? undefined : { y: -2 }}
            className="p-3 sm:p-3.5 rounded-xl bg-[#121620]/60 border border-white/[0.06] hover:border-[#539e43]/35 hover:bg-[#121620]/90 transition-colors duration-200 flex items-center gap-3 group"
          >
          ...
          <motion.div
            variants={stackCardVariants}
            whileHover={shouldReduceMotion ? undefined : { y: -2 }}
            className="p-3 sm:p-3.5 rounded-xl bg-[#121620]/60 border border-white/[0.06] hover:border-white/30 hover:bg-[#121620]/90 transition-colors duration-200 flex items-center gap-3 group"
          >
          ...
          <motion.div
            variants={stackCardVariants}
            whileHover={shouldReduceMotion ? undefined : { y: -2 }}
            className="p-3 sm:p-3.5 rounded-xl bg-[#121620]/60 border border-white/[0.06] hover:border-[#13aa52]/35 hover:bg-[#121620]/90 transition-colors duration-200 flex items-center gap-3 group"
          >
