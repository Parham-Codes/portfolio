...
export const Background = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute -top-[12%] -left-[10%] w-[550px] h-[550px] sm:w-[750px] sm:h-[750px] rounded-full bg-gradient-to-br from-[#0284c7]/16 via-[#38bdf8]/08 to-transparent blur-[120px] sm:blur-[150px] animate-ambient-slow transform-gpu"
        style={{ willChange: 'transform, opacity' }}
      />

      {/* Top-Right: Deep Indigo & Subtle Violet Glow */}
      <div
        className="absolute -top-[10%] -right-[8%] w-[500px] h-[500px] sm:w-[700px] sm:h-[700px] rounded-full bg-gradient-to-bl from-[#6366f1]/12 via-[#818cf8]/06 to-transparent blur-[130px] sm:blur-[160px] animate-ambient-reverse transform-gpu"
        style={{ willChange: 'transform, opacity' }}
      />

      {/* Mid-Left / Project Section: Deep Navy / Teal Glow */}
      <div
        className="absolute top-[42%] -left-[12%] w-[480px] h-[480px] sm:w-[650px] sm:h-[650px] rounded-full bg-gradient-to-r from-[#0369a1]/10 via-[#0e7490]/05 to-transparent blur-[140px] animate-ambient-pulse transform-gpu"
        style={{ willChange: 'transform, opacity' }}
      />

      {/* Bottom-Right / Experience & Footer: Muted Indigo Depth */}
      <div
        className="absolute -bottom-[12%] -right-[8%] w-[520px] h-[520px] sm:w-[680px] sm:h-[680px] rounded-full bg-gradient-to-tl from-[#4f46e5]/10 via-[#312e81]/06 to-transparent blur-[140px] transform-gpu"
      />
