...
export const Background = () => {
  return (
    ...
    >
      ...
      {/* Top-Left / Header: Cyan & Sky Glow (Optimized for mobile fill-rate) */}
      <div
        className="absolute -top-[12%] -left-[10%] w-[280px] h-[280px] sm:w-[750px] sm:h-[750px] rounded-full bg-gradient-to-br from-[#0284c7]/16 via-[#38bdf8]/08 to-transparent blur-[45px] sm:blur-[150px] animate-ambient-slow transform-gpu"
        style={{ willChange: 'transform, opacity' }}
      />

      {/* Top-Right: Deep Indigo & Subtle Violet Glow (Desktop & Tablet) */}
      <div
        className="hidden sm:block absolute -top-[10%] -right-[8%] w-[400px] h-[400px] sm:w-[700px] sm:h-[700px] rounded-full bg-gradient-to-bl from-[#6366f1]/12 via-[#818cf8]/06 to-transparent blur-[75px] sm:blur-[160px] animate-ambient-reverse transform-gpu"
        style={{ willChange: 'transform, opacity' }}
      />

      {/* Mid-Left / Project Section: Deep Navy / Teal Glow (Desktop) */}
      <div
        className="hidden md:block absolute top-[42%] -left-[12%] w-[380px] h-[380px] sm:w-[650px] sm:h-[650px] rounded-full bg-gradient-to-r from-[#0369a1]/10 via-[#0e7490]/05 to-transparent blur-[80px] sm:blur-[140px] animate-ambient-pulse transform-gpu"
        style={{ willChange: 'transform, opacity' }}
      />

      {/* Bottom-Right / Experience & Footer: Muted Indigo Depth */}
      <div
        className="absolute -bottom-[12%] -right-[8%] w-[280px] h-[280px] sm:w-[680px] sm:h-[680px] rounded-full bg-gradient-to-tl from-[#4f46e5]/10 via-[#312e81]/06 to-transparent blur-[50px] sm:blur-[140px] transform-gpu"
      />

      {/* 3. Subtle Architectural Developer Grid (Lightweight on mobile, masked on desktop) */}
      <div
        className="absolute inset-0 opacity-[0.22] sm:opacity-[0.42] [mask-image:none] sm:[mask-image:radial-gradient(ellipse_80%_65%_at_50%_35%,black_25%,transparent_82%)]"
      >
        <svg
